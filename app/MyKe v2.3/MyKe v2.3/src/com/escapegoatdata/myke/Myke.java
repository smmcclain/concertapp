...
public class Myke extends Activity {
	Tools t = new Tools();
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image = t.mkImageView(getApplicationContext(), R.drawable.myke_yourself,  Config.simpleImageWidth  , Config.simpleImageHeight);

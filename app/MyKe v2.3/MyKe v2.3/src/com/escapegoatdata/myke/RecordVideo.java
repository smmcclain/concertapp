...
public class RecordVideo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
     ...
     ImageView image = t.mkImageView(getApplicationContext(), R.drawable.recordvideopage,  Config.simpleImageWidth  , Config.simpleImageHeight);

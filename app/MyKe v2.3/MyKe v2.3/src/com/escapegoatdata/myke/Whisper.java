...
public class Whisper extends Activity {
	Tools t = new Tools();
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image = t.mkImageView(getApplicationContext(), R.drawable.whisper_onstage,  Config.simpleImageWidth  , Config.simpleImageHeight);
